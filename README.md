...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| English | IPA | 44 | 952 | 1,746 | 1,950 | 4,648 |
| 中文 | Pinyin | 61 | 133 | 99 | 20 | 252 |

英语词库基于 COCA 高频词数据整理，包含美式 IPA 作为主要训练标注，并保留英式 IPA 作为备用标注。中文词库基于 HSK 学习词表整理，使用带声调数字的拼音作为判定标准，并提供带调号拼音展示。
