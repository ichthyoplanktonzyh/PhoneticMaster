...
| 当前文件 | `src/l1/*`, `src/utils/phonemeDetails.ts`, `src/components/SmartRecommend.tsx` |
...
| 当前文件 | `src/utils/storage.ts`, planned `src/utils/recommendation.ts` |
...
- Phase 4.1：用 `SessionResult[]` 更新本地 mastery 和推荐排序。
