...
- **当前阶段**：v1.2 — M3 专项训练进行中（Phase 3.1、3.2 已完成，Phase 3.3 待开始）
...
2. **智能教练层**：在训练闭环成立后，结合 L1→L2 难点和本地训练历史，推荐用户下一步最该练什么。
...
| 云端增强 | 同步、标准音频、ASR、社区内容 | 否，远期可选 | 不属于 MVP 前置条件 |
